...
class PaperTrader:
    """Paper trading class for Upstox Nifty strategies."""
    ...
    def get_nifty_data(self, days_back=3):
        """Fetch Nifty 1-minute historical data."""
    ...
    def paper_order(self, action, symbol, qty, price):
        """Execute paper trade and update positions."""
        trade = {
            "action": action,
            "symbol": symbol,
            "qty": qty,
            "price": price,
            "nifty": self.last_nifty_price,
            "time": datetime.now(),
    ...
    def run_strategy_live(self, df, strategy_name):
        """Run strategy and execute live paper trades."""
