...
if not CLIENT_ID or not CLIENT_SECRET or not REDIRECT_URI:
    raise RuntimeError(
        "Missing UPSTOX_CLIENT_KEY/SECRET/REDIRECT_URI in env.py",
    )

if not USERNAME or not TOTP_SECRET or not PIN_CODE:
    raise RuntimeError(
        "Missing UPSTOX_USERNAME / UPSTOX_TOTP_SECRET / UPSTOX_PIN in env.py",
    )
...
def get_auth_code() -> str:
    ...
    try:
        ...
        # For debugging, keep window visible; later you can use headless.
